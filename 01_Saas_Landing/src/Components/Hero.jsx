...
export default function Hero() {
  return (
    <div className="w-full h-fit pt-35 bg-[radial-gradient(circle_800px_at_bottom_center,_#3b82f6,_transparent)]">
      <div className="max-w-310 flex flex-col justify-center items-center  mx-auto ">
        <div
      ...
      "
        ...
        <div className="text-8xl max-w-[80%] my-10 font-semibold leading-22 tracking-tight text-center">
        ...
        <div className="mt-20 h-100 overflow-hidden">
